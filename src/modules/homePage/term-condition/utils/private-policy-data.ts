const PrivatePolicyDetails = {
  title: '<strong>DATA PROTECTION POLICY</strong>',
  data_privacy:
    'This Data Protection Notice (“<strong>Notice</strong>”) sets out the basis which OpnCorp Pte. Ltd. may collect, use, disclose or  otherwise process personal data of our customers in accordance with the Personal Data Protection Act (“<strong>PDPA</strong>”). This Notice applies to personal data in our possession or under our control, including personal data in the possession of organisations which we have engaged to collect, use, disclose or process personal data for our purposes. It also applies to all personal data you provide to us when you access our website and when you use ourservices.',
  personal_data: {
    title: '<strong><u>PERSONAL DATA</u></strong>',
    noticeableUser: {
      heading: 'As used in this Notice:',
      customer_data:
        ' "<strong>customer</strong>" means an individual who (a) has contacted us through any means to find out more about  any goods or services we provide, or (b) may, or has, entered into a contract with us for the supply of any goods or services by us; and',
      personal_data:
        ' "<strong>personal data</strong>" means data, whether true or not, about an individual who can be identified from that data or from that data and other information to which we have or are likely to have access.',
    },
    personalNoticeableInformation: [
      'Depending on the nature of your interaction with us, some examples of personal data which we may collect from you include your name and identification information such as your NRIC number, contact information such as your address, email address or telephone number, nationality, gender, date of birth, marital status, photographs and other audio-visual information, employment information and financial information such as credit card numbers, debit card numbers or bank account information.',

      'Other terms used in this Notice shall have the meanings given to them in the PDPA (where the context so permits).',
    ],
    collectionDisclosureDetails: {
      heading: '<strong><u>COLLECTION, USE AND DISCLOSURE OF PERSONAL DATA</u></strong>',
      collectingDiclosureInformationFirst: [
      ...
      collectingDiclosureInformationLast: [
      ...
      withdrawConsentHeading: '<strong><u>WITHDRAWING YOUR CONSENT</strong></u>',
      withdrawConsent: [
      ...
      accessCorrectionDetailsHeading: '<strong><u>ACCESS TO AND CORRECTION OF PERSONAL DATA</strong></u>',
      accessCorrectionDetails: [
      ...
      protectionDetailsHeading: '<strong><u>PROTECTION OF PERSONAL DATA </u></strong>',
      protectionDetails: [
      ...
      accuracyDetailsHeading: '<strong><u>ACCURACY OF PERSONAL DATA</u></strong>',
      accuracyDetail:
        'We generally rely on personal data provided by you (or your authorised representative). In order to ensure that your personal data is current, complete and accurate, please update us if there are changes to your personal data by informing our Data Protection Officer in writing or via email at the contact details provided below.',
    },
    retentionDetailsHeading: '<strong><u>RETENTION OF PERSONAL DATA</u></strong>',
    retentionDetails: [
      'We may retain your personal data for as long as it is necessary to fulfil the purpose for which it was collected, or as required or permitted by applicable laws',

      'We will cease to retain your personal data, or remove the means by which the data can be associated with you, as soon as it is reasonable to assume that such retention no longer serves the purpose for which the personal data was collected, and is no longer necessary for legal or business purposes',
    ],
    transferOutsideSingaporeHeading: '<strong><u>TRANSFERS OF PERSONAL DATA OUTSIDE OF SINGAPORE</u></strong>',

    transferOutsideSingaporeDetails: [
    ...
    dataProtectionOfficerHeading: '<strong><u>DATA PROTECTION OFFICER </u></strong>',
    dataProtectionOfficerDetails: {
      details:
        'You may contact our Data Protection Officer if you have any enquiries or feedback on our personal data protection policies and procedures, or if you wish to make any request, in the following manner:',
      contactDetails: '<strong><u>Data Protection Officer</u></strong>',
      address: '<strong>Address:</strong> 531 Upper Cross Street, #04-95 Singapore 051531',
      emailAddress: '<strong>Email Address</strong>: <u>help@opncorp.com</u>',
    },
    cookiesPolicyHeading: '<strong><u>COOKIES POLICY</u></strong',
    cookiePolicies: [
    ...
    cookiesFunctionheading: 'We generally use cookies for the following functions:',
    cookiePolicyFunctions: [
      '<u>Strictly necessary cookies:</u> We use these cookies to enable you to use our Platforms’ essential features. These include security cookies which we use to authenticate users and protect your data. If these cookies are disabled, you may not be able to use our Platforms or some of their features.',
      '<u>Functionality cookies:</u> We use these cookies to enhance your experience when using our Platforms by storing your preferences, such as your preferred language or region.',
      '<u>Performance cookies:</u> These cookies allow us to measure how often you visit our sites and how you use them. We use this information to get a better sense of how our users engage with our journalism and to improve our sites and apps, so that users have a better experience. For example, we collect information about which of our pages are most frequently visited, and by which types of users.',
    ],
    cookiesCollected: {
      heading: 'The information collected by such cookies is aggregated and cannot be used to personally identify you.',
      details:
        '<u>Other cookies placed by third-parties:</u> Some of our Platforms may contain pages which contain embedded functions, social media tools or links supplied by third-parties (forexample, videos may sometimes be embedded from YouTube). These functions or links may contain third-party cookies. Please consult the privacy policies of these third-parties for information regarding the use of their cookies or other automated data collection tools.',
    },
    ...
    effectNoticeDetails: {
      heading: '<strong><u>EFFECT OF NOTICE AND CHANGES TO NOTICE</u></strong>',
      details: [
    ...
    datePublished: 'Date of issuance of this Personal Data Protection Policy: 10 February 2022',
  },
};

export default PrivatePolicyDetails;
