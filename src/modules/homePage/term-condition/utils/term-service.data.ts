const TermServiceDetails = {
  title: '<strong><u>T&Cs for buyers & sellers on the platform</u></strong>',
  overview: [
  ...
  platformGuidelinesHeading: 'USE OF THE PLATFORM AND/OR SERVICES',
  platformGuidelines: [
  ...
  thirdPartyVendorAcknowledgement:
  ...
  limitationandliability: {
    heading: 'Our limitation of responsibility and liability',
    libility: [
  ...
  paymentInvoiceInstruction: {
    invoice: 'Invoicing: Seller may invoice you upon the due date of any payment under a Customer Contract.',
    failure:
  ...
  disputeandCancellation: {
    heading: 'DISPUTES AND CANCELLATIONS',
    processes: [
    ...
    activeOrdersDetails: {
      heading:
        '<strong>Active orders</strong> (after requirements were submitted to the Seller and before the Seller delivers on OpnCorp):',
      processes: [
    ...
    deliveredOrdersDetails: {
      ...
      processes: [
        ...
        'The Seller requests additional payments, on or off the OpnCorp platform, by withholding the final delivery of services directly related to the agreed requirements.',
        'The Seller is withholding the final delivery of services for improved ratings',
        'Users who abuse the revisions function to gain more services from Sellers beyond the agreed requirements.',
    ...
    completedOrdersDetails: {
      heading: '<strong>Completed Orders</strong> (after the order is marked as complete and before the 14-day limitation)',
      processes: [
  ...
  applicationLawJurisdictionRules: {
    heading: 'APPLICATION LAW AND JURISDICTION',
    detail:
...
export default TermServiceDetails;
